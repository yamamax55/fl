...
- **提督能力値差別化**: 各艦隊に異なる特性の提督を配属（機動・攻撃・防御・統率特化）
...
│   └── style.css       # スタイル
├── data/
│   ├── admirals.js     # 提督マスターデータ（静的インポート）
│   └── fleets.js       # 艦隊マスターデータ（静的インポート）
├── public/
│   ├── data/
│   │   ├── admirals.json # 提督マスターデータ（バックアップ）
│   │   └── fleets.json   # 艦隊マスターデータ（バックアップ）
│   └── assets/         # ゲームアセット
